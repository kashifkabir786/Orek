...
if ( isset( $_GET[ 'category_id' ] ) ) {
     ...
     $deleteSQL = sprintf( "DELETE FROM `category_specification` WHERE `category_specification` = %s AND `category_id` = %s",
        GetSQLValueString( $_GET[ 'category_specification' ], "text" ),
