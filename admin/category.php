                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="../assets/img/category/<?php echo $row_Recordset2['image_1'] ?>"
                                                target="_blank"><img
                                                    src="../assets/img/category/<?php echo $row_Recordset2['image_1'] ?>"
                                                    width="50"></a></td>

                                        <td>
                                            <a href="add-category.php?category_id=<?php echo $row_Recordset2['category_id']; ?>"
                                                class="text-primary me-2">
                                                <i class="bi bi-pencil-square"></i>
                                            </a>
                                            <a href="delete-category.php?category_id=<?php echo $row_Recordset2['category_id']; ?>"
                                                class="text-danger">
