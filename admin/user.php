                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row_Recordset2['date_added'] ?></td>
                                        <td><a href="add-user.php?user_id=<?php echo $row_Recordset2['user_id'] ?>"> <i
                                                    class="bi bi-pencil-square me-2"></i></a> <a
                                                href="delete-user.php?user_id=<?php echo $row_Recordset2['user_id']; ?>">
