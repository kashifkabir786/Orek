                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="add-user.php?user_id=<?php echo $row_Recordset2['user_id']; ?>"><?php echo $row_Recordset2['fname'] ." " . $row_Recordset2['lname'] ?></a></td>
                                        <td><?php echo $row_Recordset2['email'] ?></td>
                                        <td><?php echo $row_Recordset2['phone_no'] ?></td>
                                        <td><?php echo $row_Recordset2['total_items'] ?></td>
                                        <td>Rs <?php echo $row_Recordset2['total_amount'] ?></td>
                                        <td><?php echo $row_Recordset2['status'] ?></td>
                                        <td><?php echo date('d-m-Y', strtotime($row_Recordset2['date'])) ?></td>
                                        <td><a href="cart-item.php?cart_id=<?php echo $row_Recordset2['cart_id']; ?>"><i
