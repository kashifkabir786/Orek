...
<?php
// Update query to join with ticket_replies
$query_Tickets = "SELECT t.*, u.fname, u.lname, u.email,
                  (SELECT COUNT(*) FROM ticket_replies WHERE ticket_id = t.ticket_id) as reply_count,
                  (SELECT created_at FROM ticket_replies WHERE ticket_id = t.ticket_id ORDER BY created_at DESC LIMIT 1) as last_reply
                  FROM tickets t 
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['last_reply'] ? date('d M Y H:i', strtotime($row['last_reply'])) : date('d M Y H:i', strtotime($row['created_at'])); ?>
                                        </td>
                                        <td>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="replyForm" action="submit-reply.php" method="post">
