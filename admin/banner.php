                        ...
                        <div class="card-body">
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    ...
                                    <?php do { ?>
                                    <tr>
                                        <td><?php echo $row_Recordset2['banner_id'] ?></td>
                                        <td><?php echo $row_Recordset2['banner_name'] ?></td>

                                        <td><a href="../assets/img/banner/<?php echo $row_Recordset2['image_1'] ?>"
                                                target="_blank"><img
                                                    src="../assets/img/banner/<?php echo $row_Recordset2['image_1'] ?>"
                                                    width="20%"></a></td>
                                        <td>
                                            <a href="add-banner.php?banner_id=<?php echo $row_Recordset2['banner_id']; ?>"
                                                class="text-primary me-2">
                                                <i class="bi bi-pencil-square"></i>
                                            </a>
                                            <a
                                                href="delete-banner.php?banner_id=<?php echo $row_Recordset2['banner_id']; ?>"><i
