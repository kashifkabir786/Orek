...
$query_Recordset2 = "SELECT * FROM site_visits";
                        ...
                        <div class="card-body">
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    <?php do { ?>
                                    <tr>
                                        <td><?php echo $row_Recordset2['visit_id']; ?></td>
                                        <td><?php echo $row_Recordset2['ip_address']; ?></td>
                                        <td><?php echo $row_Recordset2['user_agent']; ?></td>
                                        <td><?php echo date('d M y h:i A', strtotime($row_Recordset2['visit_time'])); ?>
                                        </td>
                                        <td><?php echo $row_Recordset2['page_url'] ?>%</td>
                                        <!-- <td><a href="add-item.php?item_id=<?php echo $row_Recordset2['item_id']; ?>"><i
