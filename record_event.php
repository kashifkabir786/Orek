<?php
/**
 * वेबसाइट उपयोगकर्ता इवेंट ट्रैकिंग स्क्रिप्ट
 * 
 * यह स्क्रिप्ट उपयोगकर्ता इवेंट्स को ट्रैक करता है जैसे - 
 * पेज व्यू, क्लिक्स, फॉर्म सबमिशन्स आदि।
 */
...
// इवेंट जानकारी निकालें
$eventType = $eventData['event_type'];
$sessionId = $eventData['session_id'];
$pageUrl = isset($eventData['page_url']) ? $eventData['page_url'] : '';
$eventProperties = isset($eventData['properties']) ? json_encode($eventData['properties']) : '{}';
...
// डेटाबेस में इवेंट डेटा इन्सर्ट करें
$query = "INSERT INTO user_events 
          (user_id, session_id, event_type, page_url, event_properties, 
...
if ($success) {
    echo json_encode(['success' => true, 'message' => 'इवेंट सफलतापूर्वक रिकॉर्ड किया गया है']);
} else {
    echo json_encode(['success' => false, 'message' => 'इवेंट रिकॉर्ड करते समय त्रुटि: ' . $error]);
}
?> 