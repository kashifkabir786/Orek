...
<div id="cart-items-container">
                    ...
                    <p>
                        ...
                        <span class="cart-price">
                            ₹<?php 
                                                ...
                                                ?>
                            <del class="text-muted ms-2">₹<?php echo round($cart_item['price']); ?></del>
    ...
    <div class="minicart-pricing-box">
        <ul>
            <li>
                <span>sub-total</span>
                <span><strong>₹<?php echo round($total); ?></strong></span>
            </li>
            <li>
                <span>Shipping</span>
                <span>
                    ...
                    <?php else: ?>
                    <strong>₹<?php echo $total > 0 ? '50' : '0'; ?></strong>
                    <?php endif; ?>
                </span>
            </li>
            <li class="total">
                <span>total</span>
                <span><strong>₹<?php echo $total >= 1500 ? round($total) : round($total + 50); ?></strong></span>
            </li>
        </ul>
    </div>
